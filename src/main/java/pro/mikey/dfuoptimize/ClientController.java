...
import pro.mikey.dfuoptimize.store.DiscoveryStorage;
import pro.mikey.dfuoptimize.store.GameBlockStore;
import pro.mikey.dfuoptimize.utils.BlockData;
import pro.mikey.dfuoptimize.xray.Controller;
import pro.mikey.dfuoptimize.xray.Events;
...
public class ClientController {
    ...
    private static void onSetup(final FMLCommonSetupEvent event) {
        DFUOptimize.logger.debug(I18n.get("xray.debug.init"));
