package pro.mikey.dfuoptimize.gui.utils;
...
public abstract class GuiBase extends Screen {
    public static final ResourceLocation BG_NORMAL = new ResourceLocation(DFUOptimize.PREFIX_GUI + "bg.png");
    public static final ResourceLocation BG_LARGE = new ResourceLocation(DFUOptimize.PREFIX_GUI + "bg-help.png");
