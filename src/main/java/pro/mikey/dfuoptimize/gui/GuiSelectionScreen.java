package pro.mikey.dfuoptimize.gui;
...
import pro.mikey.dfuoptimize.ClientController;
import pro.mikey.dfuoptimize.Configuration;
import pro.mikey.dfuoptimize.DFUOptimize;
import pro.mikey.dfuoptimize.gui.manage.GuiAddBlock;
import pro.mikey.dfuoptimize.gui.manage.GuiBlockList;
import pro.mikey.dfuoptimize.gui.manage.GuiEdit;
import pro.mikey.dfuoptimize.gui.utils.GuiBase;
import pro.mikey.dfuoptimize.gui.utils.ScrollingList;
import pro.mikey.dfuoptimize.gui.utils.SupportButton;
import pro.mikey.dfuoptimize.keybinding.KeyBindings;
import pro.mikey.dfuoptimize.store.BlockStore;
import pro.mikey.dfuoptimize.utils.BlockData;
import pro.mikey.dfuoptimize.xray.Controller;
...
public class GuiSelectionScreen extends GuiBase {
    private static final ResourceLocation CIRCLE = new ResourceLocation(DFUOptimize.PREFIX_GUI + "circle.png");
